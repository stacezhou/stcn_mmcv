model = dict(
    ...
    loss_fn=dict(
        type='BootstrappedCE', start_warm=5000, end_warm=10000, top_p=0.15))
custom_imports = dict(
...
log_level = 'INFO'
load_from = 'work_dirs/yv_full_train_noskip_lr/best_mIoU_iter_12800.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = 'work_dirs/test/yv_full_train_noskip_lr_topk'
out_dir = 'work_dirs/test/yv_full_train_noskip_lr_topk'
validate = True
auto_resume = False
gpu_ids = range(0, 5)
